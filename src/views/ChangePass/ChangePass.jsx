            ...
            <div className="container">
              <form onSubmit={this.onSubmitNewPass}>
                <div className="col-12 p-1" align="center">
                  ...
                  <input id="1" className="ss-login-input-text" type="password" ref={this.refPass} value={this.state.newPass} onChange={this.onPass}/><br/>
                ...
                <div className="col-12 p-1" align="center">
                  ...
                  <input id="2" className="ss-login-input-text" type="password" ref={this.refPassR} value={this.state.newPassR} onChange={this.onPassR}/><br/>
