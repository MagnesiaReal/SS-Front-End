...
class WrappedRegister extends React.Component {
  constructor(props){
    ...
    this.state = {
      ...
      btnClass: "btn ss-register-btn-black"
    };
    ...
    AXIOS.post('/verify', newUserCredentials)
      .then((res)=> {
        if (true) {
          ...
          this.props.cookie.set('userId', res.data.userId, { path: '/' });
          ...
          this.props.cookie.set('birth', this.state.birth, { path: '/'});
          this.props.cookie.set('admin', 0, { path: '/'});

          this.setState({successRegister: true});

          setTimeout(()=> {
            this.props.navigation(`/user/${res.data.userId}`);
          }, 8000);
    ...
    AXIOS.post('/register', {email: this.state.email})
      .then(res=> {
        ...
        if (err.response.status === 409){
          ...
          this.refEmail.current.className = `${this.refEmail.current.className} ss-input-error`;
  ...
  onRegister(e){
    ...
    if (this.state.pass === this.state.passr) {
      ...
      this.refPassr.current.className = `${this.refPassr.current.className} ss-input-error`;
  ...
  onShowPass(e) {
    ...
    if(this.refPass.current.type === "password") {
      ...
      this.setState({eye: "fas fa-eye-slash", btnClass: "btn ss-register-btn-black"});
    }
        ...
        <div id="propiedades-ss" className="container">
          ...
          <div className="container">
            <form onSubmit={this.onVerify}>
              <div className="row">
                <div className="col-12 ss-register-desc">
                  <p align="justify">
                ...
                <div className="col-12 p-1" align="center">
                  <input id="code" placeholder="Codigo" type="text" value={this.state.code} onChange={this.onCode} className="ss-register-input-text" required/>
                ...
                <div className="col-12 p-1" align="center">
                  <a href="##" id="ss-register-resend" onClick={this.onResend}>Reenviar Código</a>
                </div>
              </div>
            </form>
          </div>
          ...
          <div className="container">
            <form onSubmit={this.onRegister}>
              <div className="row">
                ...
                <div className="col-12 p-1" align="center">
                  <input type="submit" value="Registrar" className="btn btn-light"/>
                </div>
              </div>
            </form>
          </div>
